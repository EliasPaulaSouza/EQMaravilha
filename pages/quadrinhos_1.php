    ...
    <main class="hoc container clear">
      ...
      <div class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <img src="../artes/01.jpg" class="img_livro" alt="" />
          </div>
          <div id="control-container" class="col-md-12">
            <a href="quadrinhos.php" class="vertical-btn btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
            <a href="quadrinhos_2.php" class="vertical-btn btn btn-primary"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
          </div>
        </div>
        <br />
        <br />
